...
# Load data
Xtrain = pd.read_csv("hf://datasets/ShabN/visit-with-us-buyer-prediction/Xtrain.csv")
Xtest = pd.read_csv("hf://datasets/ShabN/visit-with-us-buyer-prediction/Xtest.csv")
ytrain = pd.read_csv("hf://datasets/ShabN/visit-with-us-buyer-prediction/ytrain.csv").squeeze()
ytest = pd.read_csv("hf://datasets/ShabN/visit-with-us-buyer-prediction/ytest.csv").squeeze()
...
# Upload to Hugging Face Space
    repo_id = "ShabN/visit-with-us-buyer-prediction"
